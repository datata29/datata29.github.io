...
윈도 함수를 사용하기 위해서는 윈도 함수 내부에 참조하고자하는 <br> 값의 위치를 명확하게 지정해야 한다.<br><br>
...
즉 윈도함수 내부에서 ,**GROUP BY**를 해준다고 보면 된다.<br>
...
**CURRENT ROW** : 현재의 행 <br> **n PRECEDING**: n행 앞 <br>
**n FOLLOWING**: n행 뒤 <br> **UNBOUNDED PRECEDING**: 이전 행 전부<br> **UNBOUNDED FOLLOWING** : 이후 행 전부 
