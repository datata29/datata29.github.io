...
(tableau) NewYork AirBnB Dashboard <br><br>
...
<img src="{{ site.baseurl }}/assets/img/nyairbnb_dash_1.jpeg" width="80%" height="80%"> <br>
...
<img src="{{ site.baseurl }}/assets/img/nyairbnb_dash_2.jpeg" width="80%" height="80%" > <br>
...
종합적으로 앞서 차트에서 살펴본 가격대와 함께 <br>
다른 옵션(방 유형, 최소 숙박일수, 리뷰 수)도 선택할 수 <br>
있게 해 , 해당되는 숙소를 맵에 표시되게 하였다.<br><br>
